      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col items-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col items-center text-center animate-on-scroll">
            <div className="inline-flex items-center gap-2 px-4 py-2 mb-6 rounded-full bg-premiumAccent/20 border border-premiumAccent/30 backdrop-blur-md">
          ...
          <div className="flex flex-col items-center text-center">
            <p className="text-xl md:text-2xl text-slate-200 font-medium mb-10 max-w-2xl leading-snug animate-on-scroll stagger-1">
              Erie PA&apos;s Best Local Roofing Contractor
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8 lg:mb-10 animate-on-scroll stagger-3 justify-center w-full sm:w-auto mt-4 lg:mt-0">
              <LeadFormModal location="Hero Section">
                <div className="relative cursor-pointer">
                  ...
                  <Button
                    size="lg"
                    className="h-16 px-12 rounded-2xl bg-premiumAccent hover:bg-premiumAccent/90 text-white font-black text-base uppercase tracking-widest shadow-xl shadow-premiumAccent/20 group w-full sm:w-auto transform hover:scale-105 transition-all duration-300"
                  >
                    GET STARTED
                  </Button>
                </div>
