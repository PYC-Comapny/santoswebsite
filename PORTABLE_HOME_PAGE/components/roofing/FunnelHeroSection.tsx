      ...
      <div className="container mx-auto px-4 relative z-10 max-w-5xl">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex items-center gap-3 mb-6 animate-on-scroll">
            <div className="relative w-10 h-10 md:w-12 md:h-12 rounded-full overflow-hidden border-2 border-premiumAccent shadow-xl shadow-premiumAccent/10">
              <Image 
                src="/logo.jpg" 
                alt="EJ's Roofing Logo"
                fill
                priority
                className="object-cover"
              />
          ...
          <div className="max-w-4xl mx-auto w-full">
            ...
            <div className="mb-8 md:mb-14 animate-on-scroll stagger-1 text-center flex justify-center w-full">
              <p className="text-[11px] sm:text-lg md:text-3xl lg:text-4xl font-black text-white uppercase mb-3 px-4 leading-tight whitespace-nowrap text-center">
                Get a <span className="text-premiumAccent">trusted local roofer</span> like EJ
              </p>
            </div>
            ...
            <div className="flex justify-center mb-10 md:mb-20 animate-on-scroll stagger-2">
              <LeadFormModal location="Funnel Hero" showGoal={false}>
                <Button 
                  size="lg"
                  className="h-14 md:h-18 px-10 md:px-20 rounded-2xl bg-emerald-500 hover:bg-emerald-600 text-white font-black text-lg md:text-2xl uppercase tracking-widest md:tracking-[0.2em] shadow-2xl shadow-emerald-500/20 transition-all duration-300 transform hover:scale-105"
                >
                  Get Free Inspection
                </Button>
              </LeadFormModal>
