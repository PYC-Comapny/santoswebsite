  ...
  const reviews = [
    {
      ...
      rating: 5,
      text: "Fix Roofing LLC installed a quality roof on my home after experiencing hurricane damage. They made the process easy to navigate and kept me informed during each step of the process. Thank you for your professionalism and expedient process.",
    },
    {
      name: 'Ali',
      meta: 'Verified Customer',
      rating: 5,
      text: "I had a great experience with Fix Roofing. They are very helpful in answering questions and help people understand the product. Their production is 2nd to none.",
    },
    {
      name: 'Miguel',
      meta: 'Verified Customer',
      rating: 5,
      text: "Excellent work done. Highly recommended. The price was quite affordable.",
    },
    {
      name: 'Joe Pontoriero',
    ...
    },
    {
      ...
      meta: '3 reviews',
      rating: 5,
      text: "Fix Roofing and the team were fantastic. They handled my leaky roof in just one day. Very professional and they didn't leave a mess behind. Highly recommend for anyone in Tampa.",
    },
    {
      name: 'Sarah L.',
      meta: '8 reviews · 2 photos',
      rating: 5,
      text: "Best price in town and even better service. They really know their stuff when it comes to older roofs. They replaced my shingles and fixed the flashing. Looks great.",
    },
    {
      name: 'David K.',
      meta: '6 reviews',
      rating: 5,
      text: "Very reliable. Showed up on time, finished ahead of schedule. They are honest and straightforward about what needs to be fixed. Definitely Tampa's best.",
    },
    {
      name: 'Jennifer M.',
      meta: '2 reviews',
      rating: 5,
      text: "Had a major leak during the last storm. The crew came out immediately and patched it up before redoing the whole thing. Saved me a lot of money and stress.",
    },
    {
      name: 'Robert P.',
      meta: 'Local Guide · 12 reviews',
      rating: 5,
      text: "Great workmanship. You can tell these guys take pride in what they do. The estimate was fair and there were no hidden costs. A+",
    },
    {
      name: 'Michelle B.',
      meta: '4 reviews · 1 photo',
      rating: 5,
      text: "Clean, fast, and professional. They replaced my gutters and a few damaged shingles. Very knowledgeable and easy to talk to.",
    },
    {
      name: 'Thomas H.',
      meta: 'Local Guide · 15 reviews',
      rating: 5,
      text: "The team is top tier. They were respectful of my property and did an amazing job on the roof replacement. I've already told my neighbors to call them.",
    },
    {
      name: 'Lisa C.',
      meta: '3 reviews',
      rating: 5,
      text: "Hardworking crew. They worked through the heat to get my roof done. Professional and ensures everything is perfect. Very happy with the result.",
    },
    {
      name: 'James R.',
      meta: '5 reviews',
      rating: 5,
      text: "Fair quote and quality work. They don't try to sell you things you don't need. They fixed my soffit and fascia quickly. Great local company.",
    },
    {
      name: 'Kevin W.',
      meta: 'Local Guide · 42 reviews',
      rating: 5,
      text: "If you need roof work in Tampa, call Fix Roofing. They are fast, local, and do excellent work. Fixed my chimney leak that two other companies couldn't find.",
    }
  ];
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-slate-500 font-medium max-w-2xl mx-auto animate-on-scroll stagger-1">
            See why homeowners in Tampa trust Fix Roofing for their most critical home protection.
          </p>
        </div>
